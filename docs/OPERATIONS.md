...
This guide describes the normal operator workflow for v3.2.2. It does not replace the broker’s API documentation or account controls.
...
## v3.2.2 paper-account validation
