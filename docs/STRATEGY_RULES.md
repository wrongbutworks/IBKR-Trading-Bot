...
This document is the current functional description of the five-stage strategy in v3.9.0. It describes application decisions; IBKR remains authoritative for accepted order state and execution.
