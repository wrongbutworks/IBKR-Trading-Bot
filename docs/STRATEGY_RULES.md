...
This document is the current functional description of the five-stage strategy in v3.3.0. It describes application decisions; IBKR remains authoritative for accepted order state and execution.
